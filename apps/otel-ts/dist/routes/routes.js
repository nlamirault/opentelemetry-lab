...
function registerRoutes(app) {
  return __awaiter(this, void 0, void 0, function() {
    ...
    return __generator(this, function(_a) {
      globalRouter = (0, express_1.Router)();
      ...
      globalRouter.get("/", function(request, response) {
        response.send("OpenTelemetry Lab / Typescript");
      });
      globalRouter.get("/version", function(request, response) {
        response.send({
          version: "v1.0.0",
        });
      });
      app.use(globalRouter);
      return [2, /*return*/ globalRouter];
    });
  });
}
